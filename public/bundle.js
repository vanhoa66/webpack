...
var _AddWord = __webpack_require__(32);
...
var Main = function (_React$Component) {
    ...
    _createClass(Main, [{
        key: "getArrWord",
        value: function getArrWord() {
            var _props = this.props,
                arrWord = _props.arrWord,
                filter = _props.filter;

            if (filter === "MEMORIZED") return arrWord.filter(function (e) {
                return e.memorized;
            });
            if (filter === "NEED_PRACTICE") return arrWord.filter(function (e) {
                return !e.memorized;
            });
            return arrWord;
        }
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                this.getArrWord().map(function (e, i) {
                    return _react2.default.createElement(_Word2.default, { key: i, myWord: e });
                }),
...
var redux = __webpack_require__(12),
    reducer = __webpack_require__(37);
...
var AddWord = function (_React$Component) {
    ...
    function AddWord() {
        ...
        return _possibleConstructorReturn(this, (AddWord.__proto__ || Object.getPrototypeOf(AddWord)).apply(this, arguments));
    }
    ...
    _createClass(AddWord, [{
        ...
        value: function render() {
            if (this.props.isAdding) return _react2.default.createElement(
                ...
                _react2.default.createElement("input", { type: "text", ref: "en" }),
                _react2.default.createElement("br", null),
                _react2.default.createElement("input", { type: "text", ref: "vn" }),
                _react2.default.createElement("br", null),
...
var Filter = function (_React$Component) {
    ...
    _createClass(Filter, [{
        key: "setFilter",
        value: function setFilter(actionType) {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    { onClick: function onClick() {
                            return _this2.setFilter("FILTER_SHOW_ALL");
                        } },
                    "Show All"
                ),
                _react2.default.createElement(
                    "button",
                    { onClick: function onClick() {
                            return _this2.setFilter("FILTER_MEMORIZED");
                        } },
                    "Memmorized"
                ),
                _react2.default.createElement(
                    "button",
                    { onClick: function onClick() {
                            return _this2.setFilter("FILTER_NEED_PRACTICE");
                        } },
                    "Need practice"
                )
            );
...
var Word = function (_React$Component) {
    ...
    _createClass(Word, [{
        ...
        key: "render",
        value: function render() {
            var _props$myWord = this.props.myWord,
                en = _props$myWord.en,
                vn = _props$myWord.vn,
                memorized = _props$myWord.memorized,
                isShow = _props$myWord.isShow;

            var btnText = memorized ? "forget" : "memorized";
            var btnShow = isShow ? vn : "-----------";
            var stylecss = memorized ? null : { textDecoration: 'line-through' };
            return _react2.default.createElement(
                "div",
                null,
                _react2.default.createElement(
                ...
                _react2.default.createElement(
                    "button",
                    { onClick: this.memmorizedWord.bind(this) },
                    btnText
                )
            );
        }
...
module.exports = (0, _reactRedux.connect)()(Word);
...
var redux = __webpack_require__(12),
    arrWord = __webpack_require__(38),
    filter = __webpack_require__(35),
    isAdding = __webpack_require__(36);

var reducer = redux.combineReducers({ arrWord: arrWord, filter: filter, isAdding: isAdding });
...
var arrWord = [{ id: 1, en: 'action', vn: 'hành động', memorized: true, isShow: false }, { id: 2, en: 'actor', vn: 'diễn viên', memorized: false, isShow: false }, { id: 3, en: 'activity', vn: 'hoạt động', memorized: true, isShow: false }, { id: 4, en: 'active', vn: 'chủ động', memorized: true, isShow: false }, { id: 5, en: 'bath', vn: 'tắm', memorized: false, isShow: false }, { id: 6, en: 'bedroom', vn: 'phòng ngủ', memorized: true, isShow: false }];

var wordReducer = function wordReducer() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : arrWord;
    var action = arguments[1];

    if (action.type === "MEMORIZED") return state.map(function (e) {
        if (e.id !== action.id) return e;
        return _extends({}, e, { memorized: !e.memorized });
    });
    if (action.type === "SHOW") return state.map(function (e) {
        if (e.id !== action.id) return e;
        return _extends({}, e, { isShow: !e.isShow });
    });
...
*/
var aa=__webpack_require__(1),l=__webpack_require__(14),B=__webpack_require__(5),C=__webpack_require__(2),ba=__webpack_require__(13),da=__webpack_require__(17),ea=__webpack_require__(18),fa=__webpack_require__(15),ia=__webpack_require__(16),D=__webpack_require__(6);
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(28), __webpack_require__(75)(module)))
...
var React = __webpack_require__(1),
    ReactDOM = __webpack_require__(31),
    Main = __webpack_require__(29),
